...
Двойные кавычки превращает в удвоенные двойные кавычки.&
...
Одинарные кавычки превращает в удвоенные двойные кавычки.
...
Удвоенные двойные кавычки превращает в обычные одинарные.
...
Аналогично предыдущей функции. Только в качестве разделителя используется знак из буфера обмена.
