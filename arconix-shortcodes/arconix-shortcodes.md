...
_Панель Arconix Shortcodes в WordPress_
...
_Блок с оранжевой заливкой и иконкой_
...
_Кнопка классическая, оранжевая и большая_

```html
[button url="http://blog.harrix.org" color="black" size="small" target="blank"]Кнопка[/button]
```

_Кнопка классическая, черная и маленькая_
